...
void ModifyUserData(AD *ap_app)
{
    ...
    UINT32 pw_len = GetStringFromEdit(IDC_USER_PASSWORD_EDIT, pw, 32);
...
void OnCommand(INT32 a_ctrl_id, INT32 a_notify_code, void *ap_ctrl)
{
    ...
    else if (a_ctrl_id == IDC_DEL_CHAT_BTN) ListBox_ResetContent(FindControl(IDC_EVENT_LIST));
...
void DrawUI()
{
    ...
    CreateButton("대화 내용 삭제", 298, 5, 100, 26, IDC_DEL_CHAT_BTN);
